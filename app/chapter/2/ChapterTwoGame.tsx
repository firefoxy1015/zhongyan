...
function CompleteScene() {
  return <section className={styles.complete}><p>第二章完成</p><h2>我听到了「招灾」的回响。</h2><span>终焉之地已经展开。第三章从破败便利店开始。</span><Link href="/chapter/3?fresh=1">进入第三章：七黑剑</Link><Link href="/">回到章节目录</Link></section>;
}
